...
EMILIA_IMG = "https://telegra.ph/file/85083e47eded1eb77a9bb.jpg"
...
PM_START_TEXT = """
`Hey There!` [👩‍💼](https://telegra.ph/file/85083e47eded1eb77a9bb.jpg) 
`My name is` *SHINCHAN*`
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD SHINCHAN TO YOUR GROUP ➕️",url="t.me/shinchangroupmanagerbot?startgroup=true"
        ),
    ],
    [
        InlineKeyboardButton(
...
HELP_STRINGS = """
`Hey there! My name is` [SHINCHAN!]("https://telegra.ph/file/85083e47eded1eb77a9bb.jpg") 
...
def gabi_about_callback(update, context):
    ...
    if query.data == "gabi_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Shinchan*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about *SHINCHAN*, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "SHINCHAN is Back Online💼")
        except Unauthorized:
            LOGGER.warning(
